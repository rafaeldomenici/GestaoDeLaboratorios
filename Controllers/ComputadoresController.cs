...
namespace GestaoDeLaboratorios.Controllers
{
    public class ComputadoresController : Controller
    {
        ...
        {
              return _context.Computadores != null ? 
                          View(await _context.Computadores.ToListAsync()) :
                          Problem("Entity set 'InfnetDbContext.Computadores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Processador,PlacaMae,Memoria,Hd,NumeroPatrimonio,DataCompra")] Computador computador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Processador,PlacaMae,Memoria,Hd,NumeroPatrimonio,DataCompra")] Computador computador)
        {
            if (id != computador.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'InfnetDbContext.Computadores'  is null.");
            }
            var computador = await _context.Computadores.FindAsync(id);
            if (computador != null)
            {
